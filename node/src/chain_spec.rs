...
fn testnet_genesis(
    ...
    let post_1gib_vk = include_bytes!("../../examples/benchmark/keys/1GiB.post.vk.scale");
    let post_1gib_vk = VerifyingKey::<Bls12>::from_bytes(post_1gib_vk).unwrap();

    let porep_1gib_vk = include_bytes!("../../examples/benchmark/keys/1GiB.porep.vk.scale");
    let porep_1gib_vk = VerifyingKey::<Bls12>::from_bytes(porep_1gib_vk).unwrap();

    let post_8mib_vk = include_bytes!("../../examples/benchmark/keys/8MiB.post.vk.scale");
    let post_8mib_vk = VerifyingKey::<Bls12>::from_bytes(post_8mib_vk).unwrap();

    let porep_8mib_vk = include_bytes!("../../examples/benchmark/keys/8MiB.porep.vk.scale");
