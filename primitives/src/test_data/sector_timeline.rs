    ...
    BlockNumber: sp_runtime::traits::BlockNumber,
{
    ...
    pub fn period_deadlines(&self) -> u64 {
    ...
    pub fn prove_commit_sectors(&self) -> Absolute<BlockNumber> {
        ...
        self.interactive_block_number() + Relative::from(BlockNumber::from(1u32))
    }

    pub fn deadline_index(&self) -> u64 {
        let blocks_since_start = self.deadline_start() - self.proving_period_start_initial();
        // TODO: move to div_ceil in Relative
        let periods_since_start: u64 =
            (blocks_since_start + self.proving_period() - Relative::one()) / self.proving_period();
