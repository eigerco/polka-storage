...
#[derive(Clone, Eq, PartialEq, Encode, Decode, RuntimeDebug, TypeInfo, MaxEncodedLen)]
pub struct OffchainDealParameters<Address, Balance, BlockNumber> {
    pub account: Address,
    pub minimum_price_per_block: Balance,
    pub deal_duration: OffchainDealDurationBound<BlockNumber>,
}

impl<Address, Balance, BlockNumber> OffchainDealParameters<Address, Balance, BlockNumber>
where
    ...
    BlockNumber: PartialOrd + Copy,
{
    ...
    pub fn validate(
        ...
        min_duration: BlockNumber,
        max_duration: BlockNumber,
    ) -> Result<DealParameters<Address, Balance, BlockNumber>, DealParameterError<BlockNumber>>
    {
...
/// values.
#[derive(Clone, Eq, PartialEq, Encode, Decode, RuntimeDebug, TypeInfo, MaxEncodedLen)]
pub struct DealParameters<Address, Balance, BlockNumber> {
    pub account: Address,
    pub minimum_price_per_block: Balance,
    pub deal_duration: DealDurationBound<BlockNumber>,
}

impl<Address, Balance, BlockNumber> DealParameters<Address, Balance, BlockNumber>
where
    Balance: PartialOrd,
    BlockNumber: sp_runtime::traits::BlockNumber,
{
    ...
    pub fn check_against_proposed_deal(
        &self,
