...
| `WPoStPeriodDeadlines`         | Represents how many challenge deadline there are in one proving period. Closely tied to `WPoStChallengeWindow`.                                                                   | 48          |
...
| `FaultMaxAge`                  | Maximum time period a [fault](../glossary.md#fault) can exist before being removed by the system.                                                                                 | 210 Minutes |
