...
pub trait MarketClientExt {
    ...
    fn withdraw_balance<Keypair>(
        ...
        Output = Result<
            Option<SubmissionResult<HashOfPsc, MktEvents::BalanceWithdrawn>>,
            subxt::Error,
        >,
    >
    where
    ...
    fn add_balance<Keypair>(
        ...
        Output = Result<Option<SubmissionResult<HashOfPsc, MktEvents::BalanceAdded>>, subxt::Error>,
    >
    where
        Keypair: subxt::tx::Signer<PolkaStorageConfig>;
    ...
    fn settle_deal_payments<Keypair>(
        ...
        Output = Result<Option<SubmissionResult<HashOfPsc, MktEvents::DealsSettled>>, subxt::Error>,
    >
    where
        Keypair: subxt::tx::Signer<PolkaStorageConfig>;
    ...
    fn publish_storage_deals<Keypair, ClientKeypair>(
        ...
        Output = Result<
            Option<SubmissionResult<HashOfPsc, MktEvents::DealPublished>>,
            subxt::Error,
        >,
    >
    where
