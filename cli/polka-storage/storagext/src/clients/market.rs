...
pub trait MarketClientExt {
    ...
    fn add_balance<Keypair>(
        ...
        Output = Result<
            Option<SubmissionResult<HashOfPsc, MktEvent, MktEvents::BalanceAdded>>,
            subxt::Error,
        >,
    >
    where
    ...
    fn settle_deal_payments<Keypair>(
        ...
        Output = Result<
            Option<SubmissionResult<HashOfPsc, MktEvent, MktEvents::DealsSettled>>,
            subxt::Error,
        >,
    >
    where
    ...
    fn publish_storage_deals<Keypair, ClientKeypair>(
        ...
        Output = Result<
            Option<SubmissionResult<HashOfPsc, MktEvent, MktEvents::DealPublished>>,
            subxt::Error,
        >,
    >
    where
